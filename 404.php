...
if(!aa_print_html($AA_STATUS_CODE)){
    ...
    <div id="main-content">
    	<div id="left-content">
			...
			<?php $error_message = stripslashes(get_option('al_error_message')); ?>
			<?php
			if($error_message !== ''){ ?>
			<p><?php echo $error_message ?></p> 
			<?php } else { ?>
			<p>We are sorry, the page you are looking for can't be found. please use the search box to find what you are looking for.</p>
			<?php } ?>
